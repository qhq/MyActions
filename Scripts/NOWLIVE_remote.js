/*
https://raw.githubusercontent.com/Sunert/Scripts/master/Task/NOWLIVE.js
nowid@ck
*/
...
const Secrets = {
    ...
    COOKIE_NOWLIVE: process.env.COOKIE_NOWLIVE, //cokie,多个用\n隔开即可
};
let Cookies = [];
...
async function start() {
    ...
    if (!Secrets.COOKIE_NOWLIVE) {
        console.log("请填写 COOKIE_NOWLIVE 后在继续");
        return;
    }
    if (!Secrets.SyncUrl) {
    ...
    Cookies = Secrets.COOKIE_NOWLIVE.split("&");
