...
// 公共变量
//cookieKey，UserId  两个参数用换行放一个secret
const Secrets = {
    COOKIE_ELM: process.env.COOKIE_ELM, //cokie,多个用\n隔开即可
...
async function downFile() {
    const url = 'https://raw.githubusercontent.com/songyangzz/QuantumultX/master/elem/elemSign.js'
