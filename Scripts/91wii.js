/*
Secrets中新建COOKIE_91WII、COOKIE_91WII_FORMHASH
登录91wii网站，在页面中查找FORMHASH，将值填入Secrets
F12开发工具中切到网络，刷新页面，查看Cookie，将值填入Secrets
*/
    ...
    $.post({
        ...
        if (error) {
            ...
            if (data.match(/(ÒÑÍê³É|\u606d\u559c\u60a8|ǩ���ɹ�~�����������ֵ)/)) {
                ...
                $.sendNotify(`${$.name} cookie已失效`, `请重新登录获取cookie`);
