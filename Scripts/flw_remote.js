/*
https://raw.githubusercontent.com/ziye12/JavaScript/main/Task/flw.js
*/
...
const Secrets = {
    ...
    FL_flwURL: process.env.FL_flwURL,
};
let Cookies = [];
...
async function start() {
    ...
    if (!Secrets.FL_flwURL) {
        console.log("请填写 FL_flwURL 后在继续");
        return;
    }
    if (!Secrets.SyncUrl) {
    ...
    Cookies = Secrets.FL_flwURL.split("\n");
