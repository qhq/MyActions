...
const Secrets = {
    ...
    DETECT_URL: process.env.JD_PRICE_DETECT_URL, //多个用\n隔开即可
...
async function changeFiele(content, cookie) {
    //替换各种信息.
    content = content.replace(/url = \[\]/, "url = " + JSON.stringify(Secrets.DETECT_URL.split("\n")))
    content = content.replace(/price = \[\]/, "price = " + JSON.stringify(Secrets.DETECT_PRICE.split("\n")))
...
async function start() {
    ...
    Cookies = Secrets.DETECT_URL//.split("\n");//脚本自带多账号，无需拆分
