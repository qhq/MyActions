...
async function changeFiele(content, cookie) {
    ...
    content = content.replace(', $.getdata("jdzz_token2") || "";', "")
    content = content.replace('$.getdata("jdzz_token1")', JSON.stringify(Secrets.JD_TOKEN.split("&")))
