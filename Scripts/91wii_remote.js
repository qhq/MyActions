...
const Secrets = {
    ...
    COOKIE_91WII: process.env.COOKIE_91WII,
    COOKIE_91WII_FORMHASH: process.env.COOKIE_91WII_FORMHASH,
};
let Cookies = [];
...
async function changeFiele(content, cookie) {
    //替换各种信息.
    content = content.replace(/process\.env\.COOKIE_91WII_FORMHASH/g, `'${Secrets.COOKIE_91WII_FORMHASH}'`)
    content = content.replace(/process\.env\.COOKIE_91WII/g, `'${Secrets.COOKIE_91WII}'`)
...
async function start() {
    ...
    Cookies = Secrets.COOKIE_91WII.split("\n");
