/*	
https://raw.githubusercontent.com/Sunert/Scripts/master/Task/Auto_Kuaishou.js	
*/	
...
const Secrets = {	
    ...
    KUAISHOUMV: process.env.KUAISHOUMV, //cokie,多个用\n隔开即可	
};	
let Cookies = [];	
...
async function changeFiele(content, cookie) {	
    //替换各种信息.	
    content = content.replace("`ali2.a.yximgs.com`","`js2.a.yximgs.com`")	
...
async function start() {	
    ...
    if (!Secrets.KUAISHOUMV) {	
        console.log("请填写 KUAISHOUMV 后在继续");	
        return;	
    }	
    if (!Secrets.SyncUrl) {	
    ...
    Cookies = Secrets.KUAISHOUMV.split("\n\n\n");	
